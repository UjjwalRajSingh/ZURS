CLASS zcl_urs_ve_calc DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_urs_ve_calc IMPLEMENTATION.


  METHOD if_sadl_exit_calc_element_read~calculate.
    CHECK NOT it_original_data IS INITIAL.

    DATA: lt_calc_data TYPE STANDARD TABLE OF zurs_travel_proc WITH DEFAULT KEY,
    ...
    LOOP AT lt_calc_data ASSIGNING FIELD-SYMBOL(<fs_calc>).
        ...
        ""Here BAPI can be used to calculate some values and send data to VE
